...
function ProdutosHome({ produto }: CardProdutoProps) {
  ...
  return (
    <div className='flex flex-col rounded-lg overflow-hidden justify-between bg-white'>
      ...
      <div className="flex flex-wrap">
        <button className='w-full text-white bg-indigo-500 hover:bg-indigo-900 flex items-center justify-center py-2'>Comprar</button>
      </div>
    </div>
  )
}
